...
public class UpozillaUnionActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_upozilla_union);

        FirebaseAnalytics mFirebaseAnalytics;
        String log = "UpozillaUnionActivity Started";
        ...
        toolbar.setTitle(R.string.upojela_o_union);
