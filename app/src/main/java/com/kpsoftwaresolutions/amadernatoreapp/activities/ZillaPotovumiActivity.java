...
public class ZillaPotovumiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zilla_potovumi);

        FirebaseAnalytics mFirebaseAnalytics;
        String log = "ZillaPotovumiActivity Started";
        ...
        toolbar.setTitle(R.string.jelar_potovumi);
